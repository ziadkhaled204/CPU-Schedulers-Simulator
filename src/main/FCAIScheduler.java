...
public class FCAIScheduler implements Scheduler {
    ...
    public void schedule(List<Process> processes) {
        ...
        // loop till all processes finish the work
        while (completedProcesses < processes.size()) {
            ...
            // update time and remaining time of the current process
            ...
            if (executionTime >= Math.ceil(currentProcess.getQuantum() * 0.4) ) {
                ...
                if (preempted) {
                    ...
                    execOrder.add(currentProcess.getName());
        ...
        // Print the log
        log.add("Execution Order:");
        log.addAll(execOrder);
